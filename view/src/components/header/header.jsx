    ...
    return (
        <div className={Styles.navbar}>
            <div className={Styles.left}>
                ...
                <MenuIcon alt='Menu Icon' className={Styles.navmobopen} onClick={toggleMenu} />
                <ul className={`${menuOpen ? Styles.showMenu : Styles.navapp}`}>
                    <li><CloseIcon alt='Close menu icon' className={Styles.navbarclose} onClick={toggleMenu} /></li>
                    {isLoggedIn ? (
                        <>
